...
//if current page changes selected row should be zero
  useEffect(() => {
    setSelectAll(false);
    setSelectedRows([]);
  }, [currentPage]);
  ...
  return (
    <div className="container overflow-x-auto mx-auto my-8">
      <div className="flex justify-between">
        <div className="mb-4">
          ...
          >
            <RefreshIcon className="h-5 w-5 text-blue-500 cursor-pointer" />
          </button>
        </div>
        <div>
          <button
            className="text-red-500 hover:text-red-700  border p-2 rounded "
      ...
      {filteredData.length > 0 ? (
          ...
          <tbody>
            {currentRows.map((row) => (
              ...
              >
                ...
                <td className="p-2 text-left text-sm italic">
                  {editingRowId === row.id ? (
                    <input
                      className="p-2"
                      type="text"
                ...
                <td className=" p-2 text-left text-sm">
                  ...
                  {editingRowId === row.id ? (
                    <button
                      className="text-green-500 border hover:text-green-700 p-2 rounded"
                      onClick={handleSave}
                    >
                    ...
                    <button
                      className="text-blue-500 border hover:text-blue-700 p-2 rounded"
                  ...
                  <button
                    className="text-red-500 hover:text-red-700 ml-2 border p-2 rounded"
        ...
        <div className="italic text-center border p-10">No results</div>
      )}
      <div className="flex justify-between">
